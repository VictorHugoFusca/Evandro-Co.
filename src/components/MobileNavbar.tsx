...
<div className='flex justify-between w-full px-5'>
    <span className='text-slate-100 font-bold text-normal'>Evandro & Co.</span>
<button 
  className='mx-right'
  type='button'
  onClick={togleMobileMenu}
  >
    ...
    <a href="#" className='text-[#282973] font-semibold'>Log in</a>
<button className='bg-[#282973] text-white rounded-lg py-1.5 sm:py-2 sm:px-3 px-2.5 md:py-3 md:px-8 '>Sign Up</button>
